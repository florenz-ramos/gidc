      ...
      <div className="grid place-items-center lg:max-w-screen-xl gap-8 mx-auto py-24 md:py-32">
        <div className="text-center space-y-8">
          ...
          <div className="max-w-screen-md mx-auto text-center text-4xl md:text-6xl font-bold">
            <h1>
              We Manufacture and <span className="text-transparent px-2 bg-gradient-to-r from-[#00d084] to-primary bg-clip-text">
                CREATE YOUR OWN
              </span>
              healthy brand
            </h1>
...
Our products are people and environment friendly.`} */}
          ...
          <p className="max-w-screen-sm mx-auto text-xl text-muted-foreground">
            {`Empowering you to create your own healthy brand with high-quality manufacturing solutions.`}
          </p>
